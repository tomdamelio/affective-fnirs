...
**⚠️ IMPORTANT - Test Data:**
- **Primary test subject: `sub-002`** - Contains complete EEG + fNIRS + Markers data
- **Secondary test subject: `sub-001`** - Contains only fNIRS + Markers (no EEG stream in XDF)
- All development and testing should use `sub-002` to ensure full pipeline validation
- Final integration testing (Task 17.1) should test both subjects to verify graceful handling of incomplete data

## Tasks

- [x] 1. Update environment and configuration infrastructure
  - [x] 1.1 Update environment.yml with pinned dependencies
  ...
  - [x] 1.2 Replace config.py with comprehensive PipelineConfig
...
- [x] 2. Implement data ingestion module (ingestion.py)
  - [x] 2.1 Create XDF file loading with LSL timestamp extraction
  ...
  - [x] 2.2 Implement stream identification by name patterns
  ...
  - [x] 2.3 Implement stream data extraction with validation
...
- [x] 3. Implement MNE object construction module (mne_builder.py)
  - [x] 3.1 Create EEG Raw object with proper channel types
  ...
  - [x] 3.2 Create fNIRS Raw object with wavelength metadata
  ...
  - [x] 3.3 Implement event marker synchronization with LSL timestamps
...
- [x] 4. Checkpoint - Verify data ingestion and MNE construction
  - Ensure all tests pass, ask the user if questions arise.
  - Verify EEG and fNIRS are in separate Raw objects
  - Confirm LSL timestamps are used for synchronization

- [x] 5. Implement fNIRS quality assessment module (fnirs_quality.py)
  - [x] 5.1 Implement Scalp Coupling Index (SCI) calculation
  ...
  - [x] 5.2 Implement Coefficient of Variation (CV) on raw intensities
  ...
  - [x] 5.3 Implement saturation and signal loss detection
  ...
  - [x] 5.4 Implement cardiac pulsation power assessment
  ...
  - [x] 5.5 Implement comprehensive bad channel marking
  ...
  - [x] 5.6 Implement quality visualization
...
- [-] 6. Implement fNIRS processing module (fnirs_processing.py)
  - [x] 6.1 Implement optical density conversion (FIRST STEP)
  ...
  - [x] 6.2 Implement motion artifact correction on OD
  ...
  - [x] 6.3 Implement short channel identification
  ...
  - [x] 6.4 Implement GLM-based short channel regression
  ...
  - [x] 6.5 Verify systemic noise reduction after SCR
  ...
  - [x] 6.6 Implement Beer-Lambert hemoglobin conversion
  ...
  - [x] 6.7 Implement hemoglobin bandpass filtering
  ...
  - [x] 6.8 Create complete fNIRS processing pipeline function
...
- [x] 7. Checkpoint - Verify fNIRS quality and processing
  - Ensure all tests pass, ask the user if questions arise.
...
- [ ] 8. Implement EEG processing module (eeg_processing.py)
  - [x] 8.1 Implement EEG bandpass filtering
  ...
  - [x] 8.2 Implement bad EEG channel detection
  ...
  - [x] 8.3 Implement ICA artifact removal
  ...
  - [x] 8.4 Implement EOG component identification
  ...
  - [x] 8.5 Implement EMG component identification
  ...
  - [x] 8.6 Implement bad channel interpolation
  ...
  - [x] 8.7 Implement Common Average Reference
  ...
  - [x] 8.8 Create complete EEG preprocessing pipeline function
...
- [x] 9. Implement EEG analysis module (eeg_analysis.py)
  ...
  - [x] 9.2 Implement time-frequency representation (TFR)
  ...
  - [x] 9.3 Implement ERD/ERS detection with statistical validation
  ...
  - [x] 9.4 Implement channel selection with fallback
  ...
  - [x] 9.5 Implement EEG visualization functions
...
- [x] 10. Checkpoint - Verify EEG processing and analysis
  - Ensure all tests pass, ask the user if questions arise.
...
- [ ] 11. Implement fNIRS analysis module (fnirs_analysis.py)
  - [x] 11.1 Implement fNIRS epoch extraction
  ...
  - [x] 11.2 Implement motor ROI channel identification
  ...
  - [x] 11.3 Implement HRF extraction and averaging
  ...
  - [x] 11.4 Implement HRF temporal dynamics validation
  ...
  - [x] 11.5 Implement HRF quality metrics
  ...
  - [x] 11.6 Implement HRF visualization functions
...
- [ ] 17. Integration testing and validation
  - [ ] 17.1 Test complete pipeline on pilot data
    ...
    - **Secondary test: sub-001** (fNIRS + Markers only, no EEG)
      - Verify pipeline handles missing EEG stream gracefully
      - Confirm fNIRS-only analysis completes successfully
    - Verify all outputs in data/derivatives/validation-pipeline/
