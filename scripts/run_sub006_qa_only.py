"""
Run QA-only report for sub-006.
...
def main() -> int:
    """Run QA-only pipeline for sub-006."""
    xdf_file = Path("data/raw/sub-006/sub-006_ses-001_task-fingertapping_recording.xdf")
    eeg_json = Path("data/raw/sub-006/sub-006_ses-001_task-fingertapping_eeg.json")
    fnirs_json = Path("data/raw/sub-006/sub-006_ses-001_task-fingertapping_nirs.json")
    output_dir = Path("data/derivatives/validation-pipeline/sub-006/ses-001")
    ...
    summary_path = output_dir / "sub-006_ses-001_task-fingertapping_desc-qa_summary.json"
